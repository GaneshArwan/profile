...
export const SideRibbonNavigation = ({ scrollTo }) => {
  ...
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 h-fit max-h-[90vh] w-16 bg-white/30 dark:bg-slate-900/30 backdrop-blur-xl border-l border-y border-white/20 dark:border-slate-800 z-40 hidden lg:[@media(min-height:830px)]:flex flex-col items-center py-8 shadow-2xl rounded-tl-3xl rounded-bl-3xl overflow-y-auto [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
